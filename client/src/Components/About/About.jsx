...
import imageMundo from '../../assets/mundoAbout.jpg'
    ...
    <div>
      <div className={styles.container}>
        <div className={styles.subConteiner}>
          <h1>Hi Welcome to Api Countries.</h1>
        ...
        <div className={styles.conteinerRedes}>
          ...
          <div className={`${styles.socialMenu} ${isOpen ? styles.open : ""}`}>
            <a
              href="https://www.linkedin.com/in/lucas-alejandro-ribotta-a80362124/"
              target="_blank"
            ...
            <a
              href="https://github.com/LucasRibotta"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialIcon} 
            >
